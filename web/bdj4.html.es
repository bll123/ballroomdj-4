...
<head>
  ...
  <!-- WT_021 -->
  <title>BallroomDJ 4 - Reproductor de música de salón</title>
  <!-- WT_022 -->
  <meta name="Description" content="BallroomDJ 4 - Reproductor de música de salón">
...
<body>
  <div class="dbgwhite">
    ...
    <div>
      ...
      <img src="/img/ballroomdj4.svg"
        alt="BallroomDJ 4 - El reproductor de música de salón"
  ...
  <div>
    <div id="dmenu" class="mdiv dispnone divmenu">
      <div class="tleft dinlineblock">
        <ul id="" class="menu">
          ...
          <!-- WT_002 -->
          <li id="" class="menuitem"
              onclick="javascript:setDisplay('donate');">Donar</li>
        </ul>
      </div>
    </div>
    <div id="dbdj4" class="mdiv dispblock">
      <div class="dflex">
        <div class="tleft dtext">
          <!-- WT_003 -->
          <p>BallroomDJ 4 (BDJ4) es un reproductor de música diseñado para ordenadores de sobremesa y portátiles (y funcionará en algunas tabletas). Está diseñado para poder reproducir música durante toda la velada sin ninguna intervención.</p>
          <!-- WT_004 -->
          <p>BDJ4 es altamente personalizable y proporciona facilidades para organizar la música de baile de salón y crear listas de canciones, listas de reproducción automáticas y listas de reproducción secuenciadas.</p>
          <!-- WT_005 -->
          <p>BDJ4 funciona en Windows, MacOS y Linux.</p>
          <!-- WT_006 -->
          <p><b><a target="_blank"
              href="https://sourceforge.net/projects/ballroomdj4/files/"
              >Descargar BallroomDJ 4</a></b>&nbsp;&nbsp;&nbsp;(<span>última versión</span> <b>#VERSION#</b>)</p>
          <!-- WT_007 -->
          <p><a target="_blank"
          ...
          <!-- WT_008 -->
          <p><a target="_blank"
              href="https://ballroomdj.org/forum/">Foro BDJ4</a></p>
          <!-- WT_009 -->
          <p><a target="_blank"
          ...
          <p><a target="_blank"
              ...
              >BDJ4 Características</a></p>
          <!-- WT_011 -->
          <p><a target="_blank"
              href="https://crowdin.com/project/ballroomdj-4"
              >Ayuda para traducir BallroomDJ 4</a></p>
          <!-- WT_012 -->
          <p>Otros sitios donde se pueden encontrar anuncios del lanzamiento de BallroomDJ 4:</p>
          <!-- WT_013 -->
          <p><a target="_blank"
              href="https://freshcode.club/projects/bdj4"
              >BDJ4 en freshcode.club</a></p>
          <!-- WT_014 -->
          <p><a target="_blank"
              href="https://www.pro-linux.de/cgi-bin/DBApp/check.cgi?ShowAppDetail.01.17981.100"
              >BallroomDJ en pro-linux.de</a>  (Deutsch)</p>
        </div>
    ...
    <div id="dbdj3" class="mdiv dispnone">
      <div class="tleft dinlineblock">
        <!-- WT_015 -->
        <p>BallroomDJ era el anterior reproductor de música de salón. Ya no es compatible.</p>
        <!-- WT_016 -->
        <p>Se insta a todos los usuarios de BallroomDJ a pasar a BallroomDJ 4</p>
        <!-- WT_017 -->
        <p><a target="_blank"
            href="https://sourceforge.net/projects/ballroomdj/files/"
            >Descargar BallroomDJ 3</a></p>
      </div>
    </div>

    <div id="ddonate" class="mdiv dispnone tleft">
      <!-- WT_018 -->
      <p>Haz un donativo a BDJ4</p>
      <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
        <input type="hidden" name="cmd" value="_s-xclick" />
        <input type="hidden" name="hosted_button_id" value="BLTFRDM5KHNDJ" />
        <input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_donate_SM.gif" border="0" name="submit" title="PayPal - The safer, easier way to pay online!" alt="Donate with PayPal button" />
      ...
      <!-- WT_019 -->
      <p>Dona a proyectos de software que utiliza BDJ4:</p>
      <!-- WT_020 -->
      <p><a href="https://videolan.org">VLC</a> (botón de donación arriba del todo)</p>
