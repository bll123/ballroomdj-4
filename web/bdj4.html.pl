...
<head>
  ...
  <!-- WT_021 -->
  <title>BallroomDJ 4 - Odtwarzacz muzyki z sali balowej</title>
  <!-- WT_022 -->
  <meta name="Description" content="BallroomDJ 4 - Odtwarzacz muzyki z sali balowej">
...
<body>
  <div class="dbgwhite">
    ...
    <div>
      ...
      <img src="/img/ballroomdj4.svg"
        alt="BallroomDJ 4 - Odtwarzacz muzyki z sali balowej"
  ...
  <div>
    <div id="dmenu" class="mdiv dispnone divmenu">
      <div class="tleft dinlineblock">
        <ul id="" class="menu">
          ...
          <!-- WT_002 -->
          <li id="" class="menuitem"
              onclick="javascript:setDisplay('donate');">Darowizna</li>
        </ul>
      </div>
    </div>
    <div id="dbdj4" class="mdiv dispblock">
      <div class="dflex">
        <div class="tleft dtext">
          <!-- WT_003 -->
          <p>BallroomDJ 4 (BDJ4) to odtwarzacz muzyczny przeznaczony dla komputerów stacjonarnych i laptopów (działa również na niektórych tabletach). Został zaprojektowany tak, aby móc odtwarzać muzykę przez cały wieczór bez żadnej interwencji.</p>
          <!-- WT_004 -->
          <p>BDJ4 jest wysoce konfigurowalny i zapewnia funkcje organizowania muzyki do tańca towarzyskiego oraz tworzenia list utworów, automatycznych list odtwarzania i sekwencyjnych list odtwarzania.</p>
          <!-- WT_005 -->
          <p>BDJ4 działa w systemach Windows, MacOS i Linux.</p>
          <!-- WT_006 -->
          <p><b><a target="_blank"
              href="https://sourceforge.net/projects/ballroomdj4/files/"
              >Pobierz BallroomDJ 4</a></b>&nbsp;&nbsp;&nbsp;(<span>najnowsza wersja</span> <b>#VERSION#</b>)</p>
          <!-- WT_007 -->
          <p><a target="_blank"
          ...
          <!-- WT_008 -->
          <p><a target="_blank"
              href="https://ballroomdj.org/forum/">Forum BDJ4</a></p>
          <!-- WT_009 -->
          <p><a target="_blank"
          ...
          <p><a target="_blank"
              ...
              >Pomoc w tłumaczeniu BallroomDJ 4</a></p>
          <!-- WT_012 -->
          <p>Inne strony, na których można znaleźć zapowiedzi wydania BallroomDJ 4:</p>
          <!-- WT_013 -->
          <p><a target="_blank"
          ...
          <p><a target="_blank"
              ...
              >BallroomDJ na pro-linux.de</a>  (Deutsch)</p>
        </div>
    ...
    <div id="dbdj3" class="mdiv dispnone">
      <div class="tleft dinlineblock">
        <!-- WT_015 -->
        <p>BallroomDJ był poprzednim odtwarzaczem muzyki z sal balowych. Nie jest on już obsługiwany.</p>
        <!-- WT_016 -->
        <p>Zachęcamy wszystkich użytkowników BallroomDJ do przejścia na BallroomDJ 4</p>
        <!-- WT_017 -->
        <p><a target="_blank"
            href="https://sourceforge.net/projects/ballroomdj/files/"
            >Pobierz BallroomDJ 3</a></p>
      </div>
    </div>

    <div id="ddonate" class="mdiv dispnone tleft">
      <!-- WT_018 -->
      <p>Przekaż darowiznę na rzecz BDJ4</p>
      <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
        <input type="hidden" name="cmd" value="_s-xclick" />
        <input type="hidden" name="hosted_button_id" value="BLTFRDM5KHNDJ" />
        <input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_donate_SM.gif" border="0" name="submit" title="PayPal - The safer, easier way to pay online!" alt="Donate with PayPal button" />
      ...
      <!-- WT_019 -->
      <p>Przekaż darowiznę na rzecz projektów oprogramowania, z których korzysta BDJ4:</p>
      <!-- WT_020 -->
      <p><a href="https://videolan.org">VLC</a> (przycisk darowizny na samej górze)</p>
