...
<head>
  ...
  <!-- WT_021 -->
  <title>BallroomDJ 4 - Přehrávač taneční hudby</title>
  <!-- WT_022 -->
  <meta name="Description" content="BallroomDJ 4 - Přehrávač taneční hudby">
...
<body>
  <div class="dbgwhite">
    ...
    <div>
      ...
      <img src="/img/ballroomdj4.svg"
        alt="BallroomDJ 4 - Přehrávač hudby pro taneční sály"
  ...
  <div>
    <div id="dmenu" class="mdiv dispnone divmenu">
      <div class="tleft dinlineblock">
        <ul id="" class="menu">
          ...
          <!-- WT_002 -->
          <li id="" class="menuitem"
              onclick="javascript:setDisplay('donate');">Darovat</li>
        </ul>
      </div>
    </div>
    <div id="dbdj4" class="mdiv dispblock">
      <div class="dflex">
        <div class="tleft dtext">
          <!-- WT_003 -->
          <p>BallroomDJ 4 (BDJ4) je hudební přehrávač určený pro stolní počítače a notebooky (funguje i na některých tabletech). Je navržen tak, aby dokázal přehrávat hudbu po celý večer bez jakéhokoli zásahu.</p>
          <!-- WT_004 -->
          <p>BDJ4 je vysoce přizpůsobitelný a poskytuje možnosti organizace hudby pro společenský tanec a vytváření seznamů skladeb, automatických playlistů a sekvenčních playlistů.</p>
          <!-- WT_005 -->
          <p>BDJ4 běží v systémech Windows, MacOS a Linux.</p>
          <!-- WT_006 -->
          <p><b><a target="_blank"
              href="https://sourceforge.net/projects/ballroomdj4/files/"
              >Stáhnout BallroomDJ 4</a></b>&nbsp;&nbsp;&nbsp;(<span>nejnovější verze</span> <b>#VERSION#</b>)</p>
          <!-- WT_007 -->
          <p><a target="_blank"
              href="https://sourceforge.net/p/ballroomdj4/wiki/en-Change%20Log"
              >Záznam o změnách</a></p>
          <!-- WT_008 -->
          <p><a target="_blank"
              href="https://ballroomdj.org/forum/">BDJ4 Fórum</a></p>
          <!-- WT_009 -->
          <p><a target="_blank"
          ...
          <p><a target="_blank"
              ...
              >BallroomDJ na adrese pro-linux.de</a>  (Deutsch)</p>
        </div>
    ...
    <div id="dbdj3" class="mdiv dispnone">
      <div class="tleft dinlineblock">
        <!-- WT_015 -->
        <p>BallroomDJ byl předchozím přehrávačem taneční hudby. Ten již není podporován.</p>
        <!-- WT_016 -->
        <p>Všichni uživatelé BallroomDJ jsou vyzváni, aby přešli na BallroomDJ 4.</p>
        <!-- WT_017 -->
        <p><a target="_blank"
            href="https://sourceforge.net/projects/ballroomdj/files/"
            >Stáhnout BallroomDJ 3</a></p>
      </div>
    </div>

    <div id="ddonate" class="mdiv dispnone tleft">
      <!-- WT_018 -->
      <p>Přispějte na BDJ4</p>
      <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
        <input type="hidden" name="cmd" value="_s-xclick" />
        <input type="hidden" name="hosted_button_id" value="BLTFRDM5KHNDJ" />
        <input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_donate_SM.gif" border="0" name="submit" title="PayPal - The safer, easier way to pay online!" alt="Donate with PayPal button" />
      ...
      <!-- WT_019 -->
      <p>Přispějte na softwarové projekty, které BDJ4 používá:</p>
      <!-- WT_020 -->
      <p><a href="https://videolan.org">VLC</a> (darovací tlačítko úplně nahoře)</p>
