...
starterBuildUI (startui_t  *starter)
{
  ...
  uiBoxPackStart (hbox, bvbox, WCONT_FREE);
  ...
  uiwidgetp = uiCreateButton (
      ...
      _("Player"), NULL, NULL);
  uiBoxPackStart (bvbox, uiwidgetp, WCONT_KEEP);
...
starterMainLoop (void *tstarter)
{
  ...
  switch (starter->startState) {
    ...
    case START_STATE_SUPPORT_INIT: {
      ...
      uiLabelSetText (starter->wcont [START_W_SUPPORT_SEND_STATUS_MSG], tbuff);
      starter->delayCount = 0;
...
starterProcessSupport (void *udata)
{
  ...
  if (*starter->latestversiondisp == '\0') {
    ...
    if (*starter->latestversiondisp == '\0') {
      ...
      uiLabelSetText (starter->wcont [START_W_DIALOG_STATUS_MSG], _("No internet connection"));
      for (int i = 0; i < START_LINK_CB_MAX; ++i) {
...
starterSupportDialogClear (startui_t *starter)
{
  ...
  uiwcontFree (starter->wcont [START_W_DIALOG_STATUS_MSG]);
  starter->wcont [START_W_DIALOG_STATUS_MSG] = NULL;
...
starterSupportResponseHandler (void *udata, int32_t responseid)
{
  ...
  if (responseid == RESPONSE_CLOSE) {
    uiDialogDestroy (starter->wcont [START_W_DIALOG]);
  }
  starterSupportMsgDialogClear (starter);
  starterSupportDialogClear (starter);
  return UICB_CONT;
...
starterCreateSupportMsgDialog (void *udata)
{
  ...
  uiBoxPackStartExpandChildren (vbox, tb, WCONT_KEEP);
  ...
  uiBoxPackStart (vbox, starter->wcont [START_W_SUPPORT_SEND_FILES], WCONT_KEEP);
  ...
  uiBoxPackStart (vbox, starter->wcont [START_W_SUPPORT_SEND_DB], WCONT_KEEP);
  ...
  starter->wcont [START_W_SUPPORT_SEND_STATUS_MSG] = uiwidgetp;
...
starterSupportMsgDialogClear (startui_t *starter)
{
  ...
  uiwcontFree (starter->wcont [START_W_SUPPORT_SEND_STATUS_MSG]);
  starter->wcont [START_W_SUPPORT_SEND_STATUS_MSG] = NULL;
