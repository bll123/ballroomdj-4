...
static datafilekey_t autoseldfkeys [] = {
  ...
  { "EXPECTEDHIGH",   AUTOSEL_EXPECTED_HIGH,    VALUE_DOUBLE, NULL, DF_NORM },
  { "EXPECTEDMULT",   AUTOSEL_EXPECTED_MULT,    VALUE_DOUBLE, NULL, DF_NORM },
  { "EXPECTEDVAR",    AUTOSEL_EXPECTED_VAR,     VALUE_DOUBLE, NULL, DF_NORM },
