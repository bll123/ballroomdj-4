...
bpmcounterBuildUI (bpmcounter_t  *bpmcounter)
{
  ...
  bpmcounter->wcont [BPM_W_WINDOW] = uiCreateMainWindow (
      ...
      _("BPM Counter"), "bdj4_icon_bpm");

  vboxmain = uiCreateVertBox (NULL);
  ...
  uiwidgetp = uiCreateButton ("b-bpmc-box",
  ...
  uiwidgetp = uiCreateButton ("b-bpmc-save",
  ...
  uiwidgetp = uiCreateButton ("b-bpmc-reset",
  ...
  uiwidgetp = uiCreateButton ("b-bpmc-close",
      bpmcounter->callbacks [BPMCOUNT_CB_EXIT],
  ...
  pathbldMakePath (imgbuff, sizeof (imgbuff),
      "bdj4_icon_bpm", BDJ4_IMG_PNG_EXT, PATHBLD_MP_DIR_IMG);
  osuiSetIcon (imgbuff);
