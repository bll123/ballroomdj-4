...
enum {
  ...
  BDJ4_DB_WRITE_TAGS            = 0x00001000,
  BDJ4_PROGRESS                 = 0x00002000,
  BDJ4_CLI                      = 0x00004000,
  BDJ4_VERBOSE                  = 0x00008000,
  BDJ4_TS_RUNSECTION            = 0x00010000,
  BDJ4_TS_RUNTEST               = 0x00020000,
  BDJ4_TS_STARTTEST             = 0x00040000,
};
