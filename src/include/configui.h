...
enum {
  ...
  CONFUI_SB_TXT_BEGIN,
  CONFUI_SB_TXT_AUDIO_OUTPUT,
  CONFUI_SB_TXT_AUDIOSRC_MODE,
  CONFUI_SB_TXT_AUDIOSRC_TYPE,
  CONFUI_SB_TXT_BPM,
  CONFUI_SB_TXT_CONTROLLER,
  CONFUI_SB_TXT_DANCE_SPEED,
  CONFUI_SB_TXT_DANCE_TIME_SIG,
  CONFUI_SB_TXT_DANCE_TYPE,
  CONFUI_SB_TXT_DISP_SEL,
  CONFUI_SB_TXT_FADE_TYPE,
  CONFUI_SB_TXT_ITUNES_STARS_10,
  CONFUI_SB_TXT_ITUNES_STARS_100,
  CONFUI_SB_TXT_ITUNES_STARS_20,
  CONFUI_SB_TXT_ITUNES_STARS_30,
  CONFUI_SB_TXT_ITUNES_STARS_40,
  CONFUI_SB_TXT_ITUNES_STARS_50,
  CONFUI_SB_TXT_ITUNES_STARS_60,
  CONFUI_SB_TXT_ITUNES_STARS_70,
  CONFUI_SB_TXT_ITUNES_STARS_80,
  CONFUI_SB_TXT_ITUNES_STARS_90,
  CONFUI_SB_TXT_MARQUEE_SHOW,
  CONFUI_SB_TXT_PLI,
  CONFUI_SB_TXT_MOBMQ_TYPE,
  CONFUI_SB_TXT_MUSIC_QUEUE,
  CONFUI_SB_TXT_PLAYER_FADE_TYPE,
  CONFUI_SB_TXT_PLAYER_CLOCK,
  CONFUI_SB_TXT_VOL_INTFC,
  CONFUI_SB_TXT_WRITE_AUDIO_FILE_TAGS,
  CONFUI_SB_TXT_MAX,
  CONFUI_SB_NUM_BEGIN,
  CONFUI_SB_NUM_AUDIOSRC_PORT,
  CONFUI_SB_NUM_DANCE_MPM_HIGH,
  CONFUI_SB_NUM_DANCE_MPM_LOW,
  CONFUI_SB_NUM_DEFAULT_VOL,
  CONFUI_SB_NUM_MOBMQ_PORT,
  CONFUI_SB_NUM_MQ_QUEUE_LEN,
  CONFUI_SB_NUM_PL_QUEUE_LEN,
  CONFUI_SB_NUM_Q_CROSSFADE,          // per queue
  ...
  CONFUI_SWITCH_MQ_SONG_INFO_ONLY,
