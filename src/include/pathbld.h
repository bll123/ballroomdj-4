...
typedef enum {
  ...
  PATHBLD_MP_DREL_DATA    = 0x10000001,
  PATHBLD_MP_DREL_HTTP    = 0x10000002,
  PATHBLD_MP_DREL_TMP     = 0x10000004,
  PATHBLD_MP_DREL_IMG     = 0x10000008,
  PATHBLD_MP_DREL_TEST_TMPL = 0x10000010,   /* used for testing only */
  /* absolute paths based in main */
  PATHBLD_IS_ABSOLUTE     = 0x20000000,
  PATHBLD_MP_DIR_MAIN     = 0x20000001,
  PATHBLD_MP_DIR_EXEC     = 0x20000002,
  PATHBLD_MP_DIR_IMG      = 0x20000004,
  PATHBLD_MP_DIR_LOCALE   = 0x20000008,
  PATHBLD_MP_DIR_TEMPLATE = 0x20000010,
  PATHBLD_MP_DIR_INST     = 0x20000020,
  /* data directory (absolute) */
  PATHBLD_MP_DIR_DATATOP  = 0x20000200,
  /* other paths */
  PATHBLD_IS_OTHER        = 0x40000000,
  PATHBLD_MP_DIR_CACHE    = 0x40000001,
  PATHBLD_MP_DIR_CONFIG   = 0x40000002,
  PATHBLD_MP_DIR_LOCK     = 0x40000004,
  /* flags */
