...
void audiosrcURI (const char *sfname, char *uri, size_t sz, int pfxlen, const char *oldfn);
void audiosrcFullPath (const char *sfname, char *fullpath, size_t sz, int pfxlen, const char *oldfn);
...
const char *audiosrcfilePrefix (void);
void audiosrcfileURI (const char *sfname, char *uri, size_t sz, int pfxlen, const char *oldfn);
void audiosrcfileFullPath (const char *sfname, char *fullpath, size_t sz, int pfxlen, const char *oldfn);
const char * audiosrcfileRelativePath (const char *nm, int pfxlen);
size_t audiosrcfileDir (const char *sfname, char *dir, size_t sz, int pfxlen);
