...
enum {
  ...
  AUDIOID_TYPE_IDENT = TAG_KEY_MAX + 3,
  AUDIOID_TYPE_STATUS_CODE = TAG_KEY_MAX + 4,
  AUDIOID_TYPE_STATUS_MSG = TAG_KEY_MAX + 5,
  AUDIOID_TYPE_ARRAY = TAG_KEY_MAX + 6,
  AUDIOID_TYPE_ROLE = TAG_KEY_MAX + 7,
  AUDIOID_TYPE_JOINPHRASE = TAG_KEY_MAX + 8,
  AUDIOID_TYPE_TOP = TAG_KEY_MAX + 9,
  AUDIOID_TYPE_RESPIDX = TAG_KEY_MAX + 10,
};
