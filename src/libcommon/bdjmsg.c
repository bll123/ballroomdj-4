...
const char *bdjmsgroutetxt [ROUTE_MAX] = {
  ...
  [ROUTE_PODCASTUPD] = "PODCASTUPD-NIU",
...
const char *bdjmsgtxt [MSG_MAX] = {
  ...
  [MSG_CHK_MAIN_SET_CROSSFADE] = "CHK_MAIN_SET_CROSSFADE",
  ...
  [MSG_CHK_SET_DELAY] = "CHK_SET_DELAY",
  [MSG_CHK_WAIT_PREP] = "CHK_WAIT_PREP",
  ...
  [MSG_WINDOW_HIDE] = "MARQUEE_HIDE",
  [MSG_MARQUEE_SET_FONT_SZ] = "MARQUEE_SET_FONT_SZ",
  [MSG_WINDOW_SHOW] = "MARQUEE_SHOW",
  ...
  [MSG_SET_PLAYBACK_CROSSFADE] = "SET_PLAYBACK_CROSSFADE",
