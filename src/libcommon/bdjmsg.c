...
const char *bdjmsgtxt [MSG_MAX] = {
  ...
  [MSG_QUEUE_PLAY_WHEN_QUEUED] = "QUEUE_PLAY_WHEN_QUEUED",
  ...
  [MSG_CHK_MAIN_GAP] = "CHK_MAIN_GAP",
  [MSG_CHK_PLAYER_FADEIN] = "CHK_PLAYER_FADEIN",
  [MSG_CHK_PLAYER_FADEOUT] = "CHK_PLAYER_FADEOUT",
  [MSG_CHK_MAIN_MAXPLAYTIME] = "CHK_MAIN_MAXPLAYTIME",
};
